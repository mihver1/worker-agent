...
from artel_core.rules import add_rule, delete_rule, list_rules, move_rule, update_rule
...
def cli(
    ...
    from artel_core.artel_bootstrap import bootstrap_artel
    ...
    if ctx.invoked_subcommand is None:
        ...
        from artel_tui.app import run_tui
...
def serve(host: str | None, port: int | None, token: str) -> None:
    ...
    from artel_server.server import run_server
...
def server_tray(project_dir: str) -> None:
    ...
    from artel_tui.server_tray import run_server_tray
...
def mcp_remove(name: str, scope: str) -> None:
    ...
    from artel_core.mcp import MCPConfig, MCPRegistry
...
def schedule_run_command(schedule_id: str, remote_url: str, token: str) -> None:
    ...
    async def _run() -> dict[str, Any]:
        ...
        return await RemoteArtelControl(resolved_remote_url, resolved_token).run_schedule(
            schedule_id
        )
...
def ext_remove(name: str) -> None:
    ...
    from artel_core.extensions_admin import remove_extension
...
def ext_update(name: str | None) -> None:
    ...
    from artel_core.extensions_admin import update_all_extensions, update_extension
...
def ext_search(query: str) -> None:
    ...
    from artel_core.extensions_admin import search_extensions
...
def ext_registry_list() -> None:
    ...
    from artel_core.extensions_admin import list_registry_entries
...
def ext_registry_add(name: str, url: str) -> None:
    ...
    from artel_core.extensions_admin import add_registry
...
def ext_registry_remove(name: str) -> None:
    ...
    from artel_core.extensions_admin import remove_registry
...
def rpc() -> None:
    ...
    from artel_server.rpc import run_rpc
...
def acp() -> None:
    ...
    from artel_server.acp import run_acp
...
def login(provider: str) -> None:
    ...
    from artel_core.provider_resolver import get_provider_env_vars
...
async def _print_mode(
    ...
    *,
    ...
    from artel_core.agent import AgentEventType
...
def _resolve_install_source(source: str) -> str:
    ...
    from artel_core.ext_registry import list_all
