...
import httpx
from artel_ai.models import Message, Role, ToolCall, ToolDef, ToolResult
from artel_ai.tool_schema import normalize_json_schema

from artel_core.execution import get_current_tool_execution_context
from artel_core.extensions import ExtensionContext
from artel_core.mcp import LoadedMCPConfig, MCPRegistry, MCPServerConfig
from artel_core.mcp_formatting import (
