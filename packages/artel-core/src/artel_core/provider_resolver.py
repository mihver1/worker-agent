...
from artel_ai.provider_specs import (
    ProviderSpec,
    get_provider_spec,
    iter_provider_specs,
)
...
def get_provider_config(config: ArtelConfig, provider_name: str) -> ProviderConfig | None:
...
def get_provider_env_vars(config: ArtelConfig, provider_name: str) -> list[str]:
...
def provider_requires_api_key(config: ArtelConfig, provider_name: str) -> bool:
...
def provider_is_supported(config: ArtelConfig, provider_name: str) -> bool:
...
def _canonical_provider_id(config: ArtelConfig, provider_name: str) -> str:
...
def _resolve_api_key_for_discovery(config: ArtelConfig, provider_name: str) -> str | None:
    provider_config = get_provider_config(config, provider_name)
