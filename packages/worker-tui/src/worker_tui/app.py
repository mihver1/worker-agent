...
class WorkerApp(App):
    ...
    def _init_local_session(self) -> None:
    ...
    async def _handle_command(self, text: str) -> None:
        ...
        if cmd == "/clear":
            ...
            self._add_message(
                ...
                "  /model <p/model>    — switch model (e.g. /model anthropic/claude-sonnet-4-20250514)\n"
                "  /models             — list all available models\n"
                "  /connect <provider> — login to a provider (anthropic, openai, kimi)\n"
...
def run_tui(remote_url: str = "", auth_token: str = "") -> None:
    """Entry point for the TUI."""
    app = WorkerApp(remote_url=remote_url, auth_token=auth_token)
    app.run()
