...
Install:
    artel ext install /path/to/extensions/artel-ext-example

Or from git:
    artel ext install git+https://github.com/your-org/artel-ext-example.git
"""
...
from artel_core.extensions import CommandHandler, Extension, hook
